 ...
 */
@WebServlet("/ReinitialisationMotDePasse")
public class ReinitialisationMotDePasse extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		RequestDispatcher dispatcher = this.getServletContext().getRequestDispatcher("/WEB-INF/JSP/ReinitialisationMotDePasse.jsp");
